    ...
    <div class="proposal-doc proposal-doc--plain">
      <table class="proposal-doc-table">
        <colgroup>
          ...
          <col class="col-hscode">
          <col class="col-size">
          <col class="col-shelflife">
          <col class="col-srp">
          <col class="col-fobrate">
          <col class="col-fob">
          <col class="col-msrp">
          <col class="col-mapp">
          <col class="col-cartonqty">
          <col class="col-moqpcs">
          <col class="col-moqctn">
          <col class="col-productsize">
          <col class="col-productwt">
          <col class="col-cartonsize">
          <col class="col-cartonwt">
          <col class="col-palletctn">
          <col class="col-palletpcs">
          <col class="col-palletwt">
